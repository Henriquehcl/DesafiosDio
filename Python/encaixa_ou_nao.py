...
um programa para verificar, à partir de dois
valores muito grandes A e B, se B corresponde
...
Cada caso de teste consiste de dois valores
A e B maiores que zero, cada um deles podendo
ter até 1000 dígitos.

Saída
Para cada caso de entrada imprima uma mensagem
indicando se o segundo valor encaixa no primeiro
